...
const controller = require('../controller/Calendario');

//router.get('/obtener', controller.getProducts);

router.get('/', authentication.isAuth, controller.getCalendar);

router.post('/add', authentication.isAuth, controller.addCalendar);

router.delete('/delete/:id', authentication.isAuth, controller.deleteCalendar);

router.put('/update/:id', authentication.isAuth, controller.updateCalendar);

router.get('/edit/:id', authentication.isAuth, controller.getCalendarbyId);
