...
const controller = require('../controller/Enfermedades');

//router.get('/obtener', controller.getProducts);

router.get('/', authentication.isAuth, controller.getEnfermedad);

router.post('/add', authentication.isAuth, controller.addEnfermedad);

router.delete('/delete/:id', authentication.isAuth, controller.deleteEnfermedad);

router.put('/update/:id', authentication.isAuth, controller.updateEnfermedad);

router.get('/edit/:id', authentication.isAuth, controller.getEnfermedadbyId);
